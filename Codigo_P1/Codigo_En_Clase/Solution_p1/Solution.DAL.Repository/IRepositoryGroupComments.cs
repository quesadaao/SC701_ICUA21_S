...
namespace Solution.DAL.Repository
{
    ...
    public interface IRepositoryGroupComments : IRepository<GroupComments>
    {
        Task<IEnumerable<GroupComments>> GetAllWithAsync();
        Task<GroupComments> GetOneByIdWithAsync(int id);
    }
}
